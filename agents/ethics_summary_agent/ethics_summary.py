...
@mcp.tool()
async def summarize_papers_ethics(urls: List[str], query: str) -> str:
    """Answer the query focusing on ethics using documents stored in Pinecone."""
    ...
    final_prompt = (
        ...
        "Focus on ethical dilemmas and moral concerns. Cite your sources using the metadata provided."
    )
