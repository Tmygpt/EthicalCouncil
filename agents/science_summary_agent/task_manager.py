...
class ScienceSummaryTaskManager(InMemoryTaskManager):
    def __init__(self, agent: ScienceSummaryAgent):
        super().__init__()
        self.agent = agent
    ...
    async def on_send_task(self, request: SendTaskRequest) -> SendTaskResponse:
        logger.info(f"Processing science summary task: {request.params.id}")
